...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_crf", default=1, type=int, help="the flag to apply crf")
    ...
    for iter, (img_name, img_list, label) in enumerate(infer_data_loader):
        ...
        if args.save_out_cam == 1:
            ...
            # scipy.misc.imsave(os.path.join(args.save_path, 'output_CAM_npy/cls_20', img_name + '.png'), pred.astype(np.uint8))
